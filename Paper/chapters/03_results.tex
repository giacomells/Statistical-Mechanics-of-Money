...
The situation now is similar but in this case the agents can have negative balances.
...
\begin{figure}[H]
    ...
    \caption{The histogram shows the money distribution of agents after a $10^7$ number of transactions, while the red line represents the theoretical Boltzmann-Gibbs distribution.
                The simulation was performed with $N=1000$, $M = 30 000$, and $\Delta m = 1$. Agents in this scenario can have negative balances.}
    \label{fig:DebtImage}
\end{figure}
