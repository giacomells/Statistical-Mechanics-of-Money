...
Therefore we can reassume the transaction mechanisms as:
\[
\Delta m =
\begin{cases}
...
Obviously, the transaction is accepted only if the payer has sufficient funds in the chosen pool.
...
\subsubsection{Proportional transfers} %Saving propensity could be added to the model, where agents save a fraction of their money before exchanging it.
